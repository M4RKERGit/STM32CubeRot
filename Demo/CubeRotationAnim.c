...
void CubeRotationAnim_Resume() {
	...
	snprintf(buf1, sizeof buf1, "800");
	BSP_LCD_DisplayStringAt(0, 117,(uint8_t *)buf1,LEFT_MODE);
	snprintf(buf2, sizeof buf2, "1600");
	BSP_LCD_DisplayStringAt(0, 170,(uint8_t *)buf2,LEFT_MODE);
	snprintf(buf2, sizeof buf2, "2400");
	BSP_LCD_DisplayStringAt(180, 220,(uint8_t *)buf2,LEFT_MODE);
